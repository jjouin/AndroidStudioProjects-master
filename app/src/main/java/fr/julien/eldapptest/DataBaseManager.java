...
import static fr.julien.eldapptest.DataBaseManager.Constants._datBaseVersion;
import static fr.julien.eldapptest.DataBaseManager.Constants._dataBaseName;
import static fr.julien.eldapptest.DataBaseManager.Constants.myTableItems;
...
public class DataBaseManager extends SQLiteOpenHelper{
    ...
    public static class Constants implements BaseColumns {
        ...
        public static final int _datBaseVersion=5;
        ...
        public static final String KEY_COL_STRIKE = "strike";
    ...
    private static final String DATABASE_CREATE_ITEMS= "create TABLE "
            ...
            + Constants.KEY_COL_STRIKE+ "  integer default 0) ";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Tomatoes')");
        ...
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Pasta')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Rice')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Yogurt')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Potatoes')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Carrot')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Cheese')");
        db.execSQL("insert into "+myTableItems+" ("+Constants.KEY_COL_name+") values ('Chocolate')");
    }
